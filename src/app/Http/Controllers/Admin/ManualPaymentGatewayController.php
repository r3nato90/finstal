...
class ManualPaymentGatewayController extends Controller
{
    ...
    public function store(PaymentGatewayRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.manual.gateway.index')->with('notify', [['success', __('admin.payment_processor.notify.traditional.create.success')]]);
    }
    ...
    public function update(PaymentGatewayRequest $request, string|int $id): RedirectResponse
    {
        ...
        return redirect()->route('admin.manual.gateway.index')->with('notify', [['success', __('admin.payment_processor.notify.traditional.update.success')]]);
    }
