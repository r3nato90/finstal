                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="form-label" for="status">{{ __('Status') }}<sup class="text-danger">*</sup></label>
                ...
                <form action="{{ route('admin.binary.staking.plan.update') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="form-label" for="update_status">{{ __('Status') }}<sup class="text-danger">*</sup></label>
