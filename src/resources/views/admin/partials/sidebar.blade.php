<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu-container" data-simplebar>
        <ul class="sidebar-menu">
            ...
            @endphp
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link collapsed {{$isSupportTicketActive ? "active" :"" }}" data-bs-toggle="collapse" href="#collapseSupportTicket"
                   role="button" aria-expanded="false" aria-controls="collapseSupportTicket">
                    <span><i class="las la-headset"></i></span>
                    <p>{{ __('Support Tickets') }}<small><i class="las la-angle-down"></i></small></p>
                </a>
                <div class="side-menu-dropdown collapse {{$isSupportTicketActive ? "show" :"" }}" id="collapseSupportTicket">
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link {{ request()->routeIs('admin.support-tickets.index') ? "active" :"" }}" href="{{route('admin.support-tickets.index')}}">
                                <p>{{ __('All Tickets') }}</p>
                            </a>
                        </li>
                    </ul>
