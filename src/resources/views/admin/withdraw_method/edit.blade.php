                        ...
                        <div class="form-wrapper">
                            <div class="row g-3">
                                ...
                                <div class="mb-3 col-lg-12 col-md-12">
                                    <label for="instructions" class="form-label">@lang('Instructions') <sup class="text-danger">*</sup></label>
                                    <textarea id="instructions" name="instruction" placeholder="@lang('Enter Instructions')"
                                              class="form-control" rows="4"
                                              aria-label="Instructions">{{$withdrawMethod->instruction ?? old('instructions')}}</textarea>
                                </div>
                            </div>
                        </div>
