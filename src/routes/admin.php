...
Route::namespace('Admin')->prefix('admin')->name('admin.')->middleware(['security.headers', 'xss'])->group(function () {
    ...
    Route::middleware(['admin', 'demo', 'admin-two-factor'])->group(function () {
        ...
        Route::prefix('support-tickets')->name('support-tickets.')->group(function () {
            ...
            Route::post('/{ticket}/status', [SupportTicketController::class, 'updateStatus'])->name('update-status');
            Route::get('/attachment/{attachment}/download', [SupportTicketController::class, 'downloadAttachment'])->name('download-attachment');
        });
