        ...
        <div class="container-fluid p-0">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <form action="{{route('admin.ico.token.store')}}" method="POST" enctype="multipart/form-data" id="tokenForm">
                                @csrf
                                ...
                                <div class="shadow-md border p-3 bg-body rounded mb-3">
                                    ...
                                    <div class="row g-4 mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="symbol" id="symbol" value="{{ old('symbol') }}" class="form-control" placeholder="@lang('Enter Symbol')" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-lg-12">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="4" placeholder="@lang('Enter token description')">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="shadow-md border p-3 bg-body rounded mb-3">
                                    ...
                                    <div class="row g-4 mb-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="current_price" id="current_price" value="{{ old('current_price', 0) }}" class="form-control"
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" name="total_supply" id="total_supply" value="{{ old('total_supply') }}" class="form-control"
                                                   placeholder="@lang('Enter Total Supply')" required>
                                        </div>

                                        <div class="col-lg-6">
                                            <label class="form-label" for="tokens_sold">@lang('Tokens Sold')</label>
                                            <input type="number" name="tokens_sold" id="tokens_sold" value="{{ old('tokens_sold', 0) }}" class="form-control"
                                ...
                                <div class="shadow-md border p-3 bg-body rounded mb-3">
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="date" name="sale_start_date" id="sale_start_date" value="{{ old('sale_start_date') }}" class="form-control" required>
                                        </div>

                                        <div class="col-lg-6">
                                            <label class="form-label" for="sale_end_date">@lang('Sale End Date') <sup class="text-danger">*</sup></label>
                                            <input type="date" name="sale_end_date" id="sale_end_date" value="{{ old('sale_end_date') }}" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-select" id="status" name="status" required>
                                                ...
                                                <option value="paused" {{ old('status') == 'paused' ? 'selected' : '' }}>@lang('Paused')</option>
                                                <option value="completed" {{ old('status') == 'completed' ? 'selected' : '' }}>@lang('Completed')</option>
                                                <option value="cancelled" {{ old('status') == 'cancelled' ? 'selected' : '' }}>@lang('Cancelled')</option>
                                            </select>
                                        </div>
