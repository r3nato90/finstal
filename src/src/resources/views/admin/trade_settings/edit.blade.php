            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="text-muted mb-0 small">{{ __('Update trading configuration for') }} <strong>{{ $tradeSetting->symbol }}</strong></p>
                    </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card simple-card">
                    <form method="POST" action="{{ route('admin.trade-settings.update', $tradeSetting->id) }}" id="tradeSettingForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="symbol" id="symbol" class="form-select @error('symbol') is-invalid @enderror" required>
                                        ...
                                        @foreach($currencies as $currency)
                                            <option value="{{ $currency->symbol }}" {{ old('symbol', $tradeSetting->symbol) == $currency->symbol ? 'selected' : '' }}>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="min_amount" id="min_amount" step="0.01" min="0.01"
                                               value="{{ old('min_amount', $tradeSetting->min_amount) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="max_amount" id="max_amount" step="0.01" min="0.01"
                                               value="{{ old('max_amount', $tradeSetting->max_amount) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="payout_rate" id="payout_rate" step="0.01" min="1" max="1000"
                                               value="{{ old('payout_rate', $tradeSetting->payout_rate) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $tradeSetting->is_active) ? 'checked' : '' }}>
                                        <label for="is_active" id="status-label">
                                            {{ old('is_active', $tradeSetting->is_active) ? __('Active') : __('Inactive') }}
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body border-top bg-light" id="financial-preview">
                            ...
                            <div class="row text-center g-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="fw-semibold" id="investment-range">${{ number_format($tradeSetting->min_amount, 2) }} - ${{ number_format($tradeSetting->max_amount, 2) }}</div>
                                </div>
                                <div class="col-md-4">
                                    <div class="small text-muted mb-1">{{ __('Example ($100 investment)') }}</div>
                                    <div class="fw-semibold text--success" id="profit-example">${{ number_format(100 * $tradeSetting->payout_rate / 100, 2) }} profit potential</div>
                                </div>
                                <div class="col-md-4">
                                    <div class="small text-muted mb-1">{{ __('Payout Rate') }}</div>
                                    <div class="fw-semibold" id="payout-display">{{ number_format($tradeSetting->payout_rate, 2) }}%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body border-top">
                            ...
                            @php
                                ...
                                $selectedDurations = old('durations', $tradeSetting->durations ?? []);
                            @endphp
                        ...
                        <div class="card-body border-top">
                            ...
                            @php
                                ...
                                $tradingHours = old('trading_hours', $tradeSetting->trading_hours ?? $defaultHours);
                            @endphp
            ...
            <div class="col-lg-4">
                ...
                <div class="card simple-card mb-4">
                    <div class="card-header bg-white border-bottom">
                        <h6 class="mb-0 fw-semibold">{{ __('Current Statistics') }}</h6>
                    </div>
                    <div class="card-body p-0">
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-muted small">{{ __('Total Trades') }}:</span>
                                <span class="fw-semibold">{{ number_format($stats['total_trades']) }}</span>
                            </div>
                        </div>
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-muted small">{{ __('Active Trades') }}:</span>
                                <span class="fw-semibold text-info">{{ number_format($stats['active_trades']) }}</span>
                            </div>
                        </div>
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-muted small">{{ __('Total Volume') }}:</span>
                                <span class="fw-semibold">${{ shortAmount($stats['total_volume']) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card preview-card sticky-top" style="top: 2rem;">
                    <div class="card-header bg-white border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge badge-simple small">{{ __('Edit Mode') }}</span>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span id="preview-symbol" class="fw-semibold">{{ $tradeSetting->symbol }}</span>
                            </div>
                        </div>
                        ...
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span id="preview-status" class="badge {{ $tradeSetting->is_active ? 'badge-active' : 'badge-simple' }} small">{{ $tradeSetting->is_active ? __('Active') : __('Inactive') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span id="preview-min" class="fw-semibold">${{ number_format($tradeSetting->min_amount, 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span id="preview-max" class="fw-semibold">${{ number_format($tradeSetting->max_amount, 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="preview-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span id="preview-payout" class="fw-semibold">{{ number_format($tradeSetting->payout_rate, 2) }}%</span>
                            </div>
                        </div>
                        ...
                        <div class="preview-item px-3">
                            ...
                            <div id="preview-durations" class="d-flex flex-wrap gap-1">
                                @if($tradeSetting->formatted_durations)
                                    @foreach(array_slice($tradeSetting->formatted_durations, 0, 5) as $duration)
                                        <span class="badge badge-simple small">{{ $duration }}</span>
                                    @endforeach
                                    @if(count($tradeSetting->formatted_durations) > 5)
                                        <small class="text-muted">+{{ count($tradeSetting->formatted_durations) - 5 }} more</small>
                                    @endif
                                @else
                                    <span class="badge badge-simple small">No durations</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="preview-item px-3">
                            ...
                            <div id="preview-trading-days">
                                @php
                                    $activeDays = [];
                                    if($tradeSetting->trading_hours) {
                                        foreach($tradeSetting->trading_hours as $day => $hours) {
                                ...
                                <small class="text-muted">
                                    {{ count($activeDays) > 0 ? implode(', ', $activeDays) . ' (09:00 - 17:00)' : 'No trading days' }}
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0 small">
                            <li class="mb-2 d-flex align-items-start">
                                ...
                                {{ __('Consider active trades before major changes') }}
                            </li>
                            <li class="mb-2 d-flex align-items-start">
                                <i class="fas fa-circle text-muted me-2 mt-1" style="font-size: 6px;"></i>
                                {{ __('Test new settings with small amounts first') }}
                            </li>
                            <li class="mb-2 d-flex align-items-start">
                                <i class="fas fa-circle text-muted me-2 mt-1" style="font-size: 6px;"></i>
                                {{ __('Monitor performance after updates') }}
                            </li>
                            <li class="mb-0 d-flex align-items-start">
                                <i class="fas fa-circle text-muted me-2 mt-1" style="font-size: 6px;"></i>
                                {{ __('Keep backup of successful settings') }}
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                ...
                statusBadge.textContent = isActive ? '{{ __("Active") }}' : '{{ __("Inactive") }}';
                statusBadge.className = isActive ? 'badge badge-active small' : 'badge badge-simple small';
                ...
                checkedDurations.forEach(checkbox => {
                    ...
                    if (label) {
                        ...
                        badge.className = 'badge badge-simple small';
                ...
                if (checkedDurations.length === 0) {
                    const badge = document.createElement('span');
                    badge.className = 'badge badge-simple small';
                    badge.textContent = 'No durations';
                    durationContainer.appendChild(badge);
                }
