            ...
            <div class="row g-0 align-items-stretch">
                <div class="col-lg-9">
                    <div class="urgent-call">
                        ...
                        <div class="text">
                            <h3>{{ __(getArrayFromValue($fixedContent?->meta, 'heading')) }}</h3>
                            <p>{{ __(getArrayFromValue($fixedContent?->meta, 'sub_heading')) }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="address-wrapper" style="background: linear-gradient(90deg,rgba(0,0,0,.9),rgba(0,0,0,0.8)) ,url({{ displayImage(getArrayFromValue($fixedContent?->meta, 'background_image')) }});">
                        <div class="address-item">
                            ...
                            <div class="content">
                                <h5>{{ __('Email') }}</h5>
                                <a href="mailto:{{ getArrayFromValue($fixedContent?->meta, 'phone') }}">{{ __(getArrayFromValue($fixedContent?->meta, 'email')) }}</a>
                            </div>
                        </div>
                        <div class="address-item">
                            <div class="icon">
                            ...
                            <div class="content">
                                <h5>{{ __('Phone') }}</h5>
                                <a href="tel:{{ getArrayFromValue($fixedContent?->meta, 'phone') }}">{{ __(getArrayFromValue($fixedContent?->meta, 'phone')) }}</a>
                            </div>
                        </div>
                        <div class="address-item">
                            <div class="icon">
                            ...
                            <div class="content">
                                <h5>{{ __('Location') }}</h5>
                                <p>{{ __(getArrayFromValue($fixedContent?->meta, 'address')) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-wrapper contact-form">
                        <div class="subtitle">
                            <h3>{{ __(getArrayFromValue($fixedContent?->meta, 'title')) }}</h3>
                        </div>
