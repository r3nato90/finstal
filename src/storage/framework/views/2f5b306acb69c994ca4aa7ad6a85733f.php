    ...
    <section>
        <div class="container-fluid p-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.binary.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4 mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-select range-type" id="type" name="type" required>
                                    <option value="<?php echo e(App\Enums\Investment\InvestmentRage::RANGE->value); ?>"><?php echo e(__(\App\Enums\Investment\InvestmentRage::getName(App\Enums\Investment\InvestmentRage::RANGE->value))); ?></option>
                                    <option value="<?php echo e(App\Enums\Investment\InvestmentRage::FIXED->value); ?>"><?php echo e(__(\App\Enums\Investment\InvestmentRage::getName(App\Enums\Investment\InvestmentRage::FIXED->value))); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                ...
                                <select class="form-select" id="interest_type" name="interest_type" required>
                                    <option value="<?php echo e(App\Enums\Investment\InterestType::PERCENT->value); ?>" selected><?php echo e(__(\App\Enums\Investment\InterestType::getName(App\Enums\Investment\InterestType::PERCENT->value))); ?></option>
                                    <option value="<?php echo e(App\Enums\Investment\InterestType::FIXED->value); ?>"><?php echo e(__(\App\Enums\Investment\InterestType::getName(App\Enums\Investment\InterestType::FIXED->value))); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" value="<?php echo e(old('interest_rate')); ?>" class="form-control" id="interest_rate"
                                           name="interest_rate" placeholder="<?php echo app('translator')->get('Enter rate'); ?>"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select class="form-select" id="time" name="time_id" required>
                                    ...
                                    <?php $__currentLoopData = $timeTables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeTable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($timeTable->id); ?>"><?php echo e(__($timeTable->name)); ?></option>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select class="form-select" id="interest_return_type" name="interest_return_type" required>
                                    <option value="<?php echo e(\App\Enums\Investment\ReturnType::LIFETIME->value); ?>" selected><?php echo e(__(\App\Enums\Investment\ReturnType::getName(App\Enums\Investment\ReturnType::LIFETIME->value))); ?></option>
                                    <option value="<?php echo e(\App\Enums\Investment\ReturnType::REPEAT->value); ?>"><?php echo e(__(\App\Enums\Investment\ReturnType::getName(App\Enums\Investment\ReturnType::REPEAT->value))); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="mb-4 col-lg-12">
                                ...
                                <textarea class="form-control" name="terms_policy" id="terms_policy" rows="3" required><?php echo e(old('terms_policy')); ?></textarea>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="shadow-md border p-3 bg-body rounded ">
                                    <h5><?php echo app('translator')->get('Notify users'); ?></h5>
                                    <hr>
                                    <div class="row gy-3 my-3">
                                        <div class="col-lg-10 col-md-8 col-sm-12">
                                            <?php echo app('translator')->get('If you activate the notification status, all users will be notified and have the opportunity to review and consider investing in this plan.'); ?>
                                        </div>
                    ...
                    var amount = `
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="minimum" name="minimum" placeholder="<?php echo app('translator')->get('Enter Amount'); ?>" step="any" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="maximum" name="maximum" placeholder="<?php echo app('translator')->get('Enter Amount'); ?>" step="any" required>
                            </div>
                        </div>`;
                } else {
                    var amount = `
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount" placeholder="<?php echo app('translator')->get('Enter Amount'); ?>" step="any" required>
                            </div>
                        </div>`;
                }
                ...
                if (type == 2) {
                    var interestFields = `
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" name="repeat_time" id="repeat_time" class="form-control" placeholder="<?php echo app('translator')->get('Enter Number'); ?>">
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="form-label" for="recapture_type"><?php echo app('translator')->get('Capital back'); ?> <sup class="text-danger">*</sup></label>
                            <select class="form-select" id="recapture_type" name="recapture_type">
                                <option value="<?php echo e(\App\Enums\Investment\Recapture::YES->value); ?>" selected><?php echo e(__(\App\Enums\Investment\Recapture::getName(App\Enums\Investment\Recapture::YES->value))); ?></option>
                                <option value="<?php echo e(\App\Enums\Investment\Recapture::NO->value); ?>"><?php echo e(__(\App\Enums\Investment\Recapture::getName(App\Enums\Investment\Recapture::NO->value))); ?></option>
                                <option value="<?php echo e(\App\Enums\Investment\Recapture::HOLD->value); ?>"><?php echo e(__(\App\Enums\Investment\Recapture::getName(App\Enums\Investment\Recapture::HOLD->value))); ?></option>
                            </select>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u864690811/domains/nextbroker.online/public_html/src/resources/views/admin/binary/create.blade.php ENDPATH**/ ?>