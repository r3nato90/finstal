                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="form-label" for="status"><?php echo e(__('Status')); ?><sup class="text-danger">*</sup></label>
                ...
                <form action="<?php echo e(route('admin.binary.staking.plan.update')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="form-label" for="update_status"><?php echo e(__('Status')); ?><sup class="text-danger">*</sup></label>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.updateBtn').on('click', function(event) {
                ...
                const minimum_amount = $(this).data('minimum_amount');
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/finfunder/src/resources/views/admin/investment/staking/index.blade.php ENDPATH**/ ?>