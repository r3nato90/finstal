...
<div class="banner-section">
    <div class="banner-bg">
        <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent->meta, 'background_image'), '2470x1529')); ?>"
             alt="<?php echo e(__('Background Image')); ?>">
    </div>
        ...
        <div class="row align-items-start gy-5">
            <div class="col-lg-7">
                <div class="banner-content">
                    <h1><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'heading'))); ?></h1>
                    <p><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'sub_heading'))); ?></p>
                    <div class="d-flex justify-content-between align-items-end gap-lg-4 gap-2">
                        <div
                            ...
                            <a href="<?php echo e(__(getArrayFromValue($fixedContent?->meta, 'btn_url'))); ?> "
                               class="i-btn banner-btn"><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'btn_name'))); ?> <i
                                    class="bi bi-arrow-right-short"></i></a>
                            <div class="video-pluse">
                                <span></span>
                                <span></span>
                                <span></span>
                                <a data-fancybox href="<?php echo e(getArrayFromValue($fixedContent?->meta, 'video_link')); ?>"><i
                        ...
                        <div class="global-users">
                            ...
                            <div class="text">
                                <p><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'first_text'))); ?></p>
                                <p><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'second_text'))); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <ul class="banner-features mb-60">
                    <li>
                        <span><?php echo getArrayFromValue($fixedContent?->meta, 'first_icon') ?></span><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'first_title'))); ?>

                    </li>
                    <li>
                        <span><?php echo getArrayFromValue($fixedContent?->meta, 'second_icon') ?></span><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'second_title'))); ?>

                    </li>
                    <li>
                        <span><?php echo getArrayFromValue($fixedContent?->meta, 'third_icon') ?></span><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'third_title'))); ?>

                    </li>
                </ul>

                <?php if($icoTokenSetting != 1): ?>
                    <?php if(!$activePhase): ?>
                        <div class="providers">
                            <div class="row row-cols-lg-4 row-cols-md-4 row-cols-sm-4 row-cols-2 justify-content-lg-start justify-content-center align-items-center g-4">
                                <div class="col">
                                    <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'first_provider_image'), '106x22')); ?>" alt="<?php echo e(__('banner-coin1')); ?>">
                                </div>
                                <div class="col">
                                    <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'second_provider_image'), '106x22')); ?>" alt="<?php echo e(__('banner-coin2')); ?>">
                                </div>
                                <div class="col">
                                    <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'third_provider_image'), '106x22')); ?>" alt="<?php echo e(__('banner-coin3')); ?>">
                                </div>
                                <div class="col">
                                    <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'fourth_provider_image'), '106x22')); ?>" alt="<?php echo e(__('banner-coin4')); ?>">
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <?php if($icoTokenSetting == 1): ?>
                    <?php if($activePhase): ?>
                        <div class=" count-down-wrap bg-opacity-100 rounded-3 shadow-lg p-4 max-w-md w-100">
                            ...
                            <p class="text-center text-white mb-3"><?php echo e(__('Ends In')); ?></p>
                            <div class="d-flex justify-content-center gap-xl-4 gap-2 text-center mb-3">
                                ...
                                <div class="bg-white text-dark px-xl-3 px-2 py-2 rounded">
                                    ...
                                    <small><?php echo e(__('Hours')); ?></small>
                                </div>
                                <div class="bg-white text-dark px-xl-3 px-2 py-2 rounded">
                                    <h2 class="d-block" id="minutes">0</h2>
                                    <small><?php echo e(__('Minutes')); ?></small>
                                </div>
                                <div class="bg-white text-dark px-xl-3 px-2 py-2 rounded">
                                    <h2 class="d-block" id="seconds">0</h2>
                                    <small><?php echo e(__('Seconds')); ?></small>
                                </div>
                            </div>
                            <p class="text-center text-white h4 mb-1">
                                <?php echo e(shortAmount($activePhase->tokens_sold * $activePhase->price)); ?> <?php echo e(getCurrencyName()); ?> Raised
                            </p>
                            <p class="text-center text-white mb-3"><?php echo e(__('Total Funds Raised')); ?></p>

                            <div class="progress mb-5">
                                <div class="progress-bar bg-warning" style="width: <?php echo e($activePhase->tokens_sold / ($activePhase->total_supply - $activePhase->tokens_sold) * 100); ?>%"></div>
                            </div>
                            <p class="text-center text-white mb-2">
                                <?php echo e(number_format(($activePhase->tokens_sold / ($activePhase->total_supply - $activePhase->tokens_sold)) * 100, 2)); ?>% target raised
                            </p>
                            <p class="text-center text-white mb-4">
                                1 <?php echo e(getCurrencyName()); ?> = <?php echo e(number_format($activePhase->price)); ?> <?php echo e($activePhase->symbol); ?>

                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="<?php echo e(route('user.ico.index')); ?>" class="i-btn btn--primary btn--md capsuled text-center">
                                   <?php echo e(__(' Buy Tokens')); ?>

                                </a>
                                <button class="btn btn-link text-decoration-none d-flex align-items-center text-white">
                                    <span class="me-2"> <?php echo e(__('Watch Video')); ?> </span>
                                    <div class="video-pluse">
                                        <span></span>
                                        <span></span>
                                        <span></span>
                    ...
                    <?php else: ?>
                        <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'main_image'), '593x586')); ?>"
                             alt="<?php echo e(__('Main Image')); ?>">
                    <?php endif; ?>
                <?php else: ?>
                    <img src="<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'main_image'), '593x586')); ?>"
                         alt="<?php echo e(__('Main Image')); ?>">
...
<?php if($activePhase): ?>
    <?php $__env->startPush('script-push'); ?>
        <script>
            function countdown() {
                const endTime = new Date("<?php echo e($activePhase->sale_end_date); ?>").getTime();
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/u864690811/domains/nextbroker.online/public_html/src/resources/views/default_theme/component/banner.blade.php ENDPATH**/ ?>