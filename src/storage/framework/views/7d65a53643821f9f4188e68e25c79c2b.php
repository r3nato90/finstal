            ...
            <div class="row g-0 align-items-stretch">
                <div class="col-lg-9">
                    <div class="urgent-call">
                        ...
                        <div class="text">
                            <h3><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'heading'))); ?></h3>
                            <p><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'sub_heading'))); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="address-wrapper" style="background: linear-gradient(90deg,rgba(0,0,0,.9),rgba(0,0,0,0.8)) ,url(<?php echo e(displayImage(getArrayFromValue($fixedContent?->meta, 'background_image'))); ?>);">
                        <div class="address-item">
                            ...
                            <div class="content">
                                ...
                                <a href="mailto:<?php echo e(getArrayFromValue($fixedContent?->meta, 'phone')); ?>"><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'email'))); ?></a>
                            </div>
                        </div>
                        <div class="address-item">
                            <div class="icon">
                            ...
                            <div class="content">
                                ...
                                <a href="tel:<?php echo e(getArrayFromValue($fixedContent?->meta, 'phone')); ?>"><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'phone'))); ?></a>
                            </div>
                        </div>
                        <div class="address-item">
                            <div class="icon">
                            ...
                            <div class="content">
                                ...
                                <p><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'address'))); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-wrapper contact-form">
                        <div class="subtitle">
                            <h3><?php echo e(__(getArrayFromValue($fixedContent?->meta, 'title'))); ?></h3>
                        </div>
...
<?php echo $__env->make(getActiveTheme().'.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u864690811/domains/nextbroker.online/public_html/src/resources/views/default_theme/contact.blade.php ENDPATH**/ ?>