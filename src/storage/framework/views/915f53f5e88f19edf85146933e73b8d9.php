<div class="d-sidebar" id="user-sidebar">
    ...
    <div class="main-nav sidebar-menu-container">
        <ul class="sidebar-menu">
            ...
            <!-- SUPPORT SECTION -->
            <li class="sidebar-menu-item">
                <a class="sidebar-menu-link collapsed <?php echo e(request()->routeIs('user.support-tickets.*') ? 'active' : ''); ?>" data-bs-toggle="collapse" href="#collapseSupport" role="button" aria-expanded="false" aria-controls="collapseSupport">
                    <span><i class="bi bi-headset"></i></span>
                    <p><?php echo e(__('Support')); ?>  <small><i class="las la-angle-<?php echo e(request()->routeIs('user.support-tickets.*') ? "up" : "down"); ?>"></i></small></p>
                </a>
                <div class="side-menu-dropdown collapse <?php echo e(request()->routeIs('user.support-tickets.*') ? 'show' : ''); ?>" id="collapseSupport">
                    <ul class="sub-menu <?php echo e(request()->routeIs('user.support-tickets.*') ? "open-slide" : ""); ?>">
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e(request()->routeIs('user.support-tickets.index') ? 'active' : ''); ?>" href="<?php echo e(route('user.support-tickets.index')); ?>" aria-expanded="false">
                                <p><?php echo e(__('My Tickets')); ?></p>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a class="sidebar-menu-link <?php echo e(request()->routeIs('user.support-tickets.create') ? 'active' : ''); ?>" href="<?php echo e(route('user.support-tickets.create')); ?>" aria-expanded="false">
                                <p><?php echo e(__('Create Ticket')); ?></p>
                            </a>
                        </li>
                    </ul>
                </div>
...
<?php /**PATH /var/www/html/finfunder/src/resources/views/user/partials/side-bar.blade.php ENDPATH**/ ?>